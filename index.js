const UnaccentedSearchFilterPlugin = require("./src/PostgraphileUnaccentFilterPlugin.ts");

module.exports = function UnaccentedSearchFilterPlugin(
  builder,
  options
) {
  ...
  UnaccentedSearchFilterPlugin(builder, options);
};
